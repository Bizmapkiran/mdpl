...
def get_raven_channel(doctype, method):
    ...
    if method in event_map:
        ...
        raven_notification = frappe.db.get_list(
            ...
            fields=["raven_channel","subject" ,"channel","name","condition", "message", "json", "link", "pdf_link", "print_format"]
        )
...
def trigger_on_save_for_value_change(doc, method):
    ...
    raven_notification = frappe.db.get_list(
            ...
            fields=["raven_channel","subject" ,"channel","event","value_changed","name","condition", "message", "json", "link", "pdf_link", "print_format"]
        )
